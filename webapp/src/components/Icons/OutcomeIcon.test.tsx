...
describe("OutcomeIcon", () => {
  it("should display a checkIcon if the label contains 'Correct'", () => {
  ...
  it("should display a XIcon if the label contains 'Incorrect'", () => {
  ...
  it("should display the expected color for the label 'Correct & Predicted'", () => {
    renderOutcomeIcon("CorrectAndPredicted");
    expect(screen.getByLabelText("Correct & Predicted")).toHaveStyle(
      "color: #00B686"
    );
  });
  it("should display the expected color for the label 'Correct & Rejected'", () => {
    renderOutcomeIcon("CorrectAndRejected");
    expect(screen.getByLabelText("Correct & Rejected")).toHaveStyle(
      "color: #456857"
    );
  });
  it("should display the expected color for the label 'Incorrect & Predicted'", () => {
    renderOutcomeIcon("IncorrectAndPredicted");
    expect(screen.getByLabelText("Incorrect & Predicted")).toHaveStyle(
      "color: #E32437"
    );
  });
  it("should display the expected color for the label 'Incorrect & Rejected'", () => {
